                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="#" onclick="getElementById('logout').submit()"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Géneros</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="{{ route('genders.index') }}">Listado de géneros</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Países</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="{{ route('countries.index') }}">Listado de países</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Directores</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="{{ route('directors.index') }}">Listado de directores</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Películas</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="{{ route('movies.index') }}">Listado de películas</a></li>
                            </ul>
                        </li>
